...
|---|---|---|
| `min_importance` | 0.10 | Skip memories below this score |
| `cross_turn_extraction` | true | Enable 4-message arc extraction |
| `max_memories_per_type` | 5000 | Per-type capacity cap |
| `conflict_threshold` | 0.92 | Cosine similarity threshold for conflict detection |
| `top_n_prefilter` | 200 | Pre-filter to top-N before embedding |
| `final_top_n` | 100 | Final cap on memories persisted per call |
